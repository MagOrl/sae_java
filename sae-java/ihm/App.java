...
public class App extends Application {
   ...
   private GridPane gridPane() {
      ...
      var1.add(new Label("Identifiant"), 0, 0);
      var1.add(new Label("Mot de passe"), 0, 1);
   ...
   private HBox root() {
      ...
      var2.setPrefWidth(500.0);
      HBox.setMargin(var2, new Insets(200.0));
